...
(function dartProgram() {
  ...
  N = {ArgParser: function ArgParser(t0, t1, t2, t3, t4, t5) {
    ...
    withWarnCallback: function(warn, callback, $T) {
      return P.runZoned(new N.withWarnCallback_closure(callback, $T), P.LinkedHashMap__makeLiteral([C.Symbol__warn, warn]));
    },
    ...
    _SerializeVisitor$0: function(indentWidth, inspect, lineFeed, quote, sourceMap, style, useSpaces) {
      var t1 = sourceMap ? new D.SourceMapBuffer0(new P.StringBuffer(""), H.setRuntimeTypeInfo([], [L.Entry]), P.LinkedHashMap_LinkedHashMap$_empty(P.Uri, Y.SourceFile)) : new N.NoSourceMapBuffer0(new P.StringBuffer("")),
    ...
    withWarnCallback0: function(warn, callback, $T) {
      return P.runZoned(new N.withWarnCallback_closure0(callback, $T), P.LinkedHashMap__makeLiteral([C.Symbol__warn, warn]));
    },
  ...
  Z = {
    ...
    MergedMapView$0: function(maps, $K, $V) {
      var t1 = new Z.MergedMapView0(P.LinkedHashMap_LinkedHashMap$_empty($K, [P.Map, $K, $V]), [$K, $V]);
  ...
  V = {
    ...
    Stylesheet_Stylesheet$parse: function(contents, syntax, logger, url) {
      ...
      switch (syntax) {
        case C.Syntax_Sass:
          ...
          return new U.SassParser(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration), t1, t2).parse$0();
        case C.Syntax_SCSS:
          t1 = S.SpanScanner$(contents, url);
          t2 = logger == null ? C.StderrLogger_false : logger;
        ...
        case C.Syntax_CSS:
          t1 = S.SpanScanner$(contents, url);
          t2 = logger == null ? C.StderrLogger_false : logger;
          return new Q.CssParser(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration), t1, t2).parse$0();
        default:
    ...
    cloneCssStylesheet0: function(stylesheet, extender) {
      var result = extender.clone$0(),
        t1 = stylesheet.get$span(),
        t2 = B.ModifiableCssNode0,
        t3 = H.setRuntimeTypeInfo([], [t2]);
      return new S.Tuple2(new V._CloneCssVisitor0(result.item2)._clone_css$_visitChildren$2(new V.ModifiableCssStylesheet0(t1, new P.UnmodifiableListView(t3, [t2]), t3), stylesheet), result.item1, [V.ModifiableCssStylesheet0, F.Extender0]);
    },
    ...
    Stylesheet$0: function(children, span, plainCss) {
      var t1 = H.setRuntimeTypeInfo([], [T.UseRule0]),
        t2 = H.setRuntimeTypeInfo([], [L.ForwardRule0]),
        t3 = P.List_List$unmodifiable(children, O.Statement0),
    ...
    Stylesheet_Stylesheet$parse0: function(contents, syntax, logger, url) {
      ...
      switch (syntax) {
        case C.Syntax_Sass0:
          ...
          return new U.SassParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, t2).parse$0();
        case C.Syntax_SCSS0:
          t1 = S.SpanScanner$(contents, url);
          t2 = logger == null ? C.C_StderrLogger : logger;
          return new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, t2).parse$0();
        case C.Syntax_CSS0:
          t1 = S.SpanScanner$(contents, url);
          t2 = logger == null ? C.C_StderrLogger : logger;
          return new Q.CssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, t2).parse$0();
        default:
          throw H.wrapException(P.ArgumentError$("Unknown syntax " + syntax.toString$0(0) + "."));
      }
    },
  ...
  G = {Option: function Option(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11) {
    ...
    ModifiableCssMediaRule$0: function(queries, span) {
      var t1 = P.List_List$unmodifiable(queries, F.CssMediaQuery0),
        t2 = B.ModifiableCssNode0,
        t3 = H.setRuntimeTypeInfo([], [t2]);
      if (J.get$isEmpty$asx(queries))
        H.throwExpression(P.ArgumentError$value(queries, "queries", "may not be empty."));
      return new G.ModifiableCssMediaRule0(t1, span, new P.UnmodifiableListView(t3, [t2]), t3);
    },
  ...
  E = {Result: function Result() {
    ...
    _EvaluateVisitor$0: function(functions, importCache, logger, nodeImporter, sourceMap) {
      ...
      t5 = new E._EvaluateVisitor0(importCache, nodeImporter, P.LinkedHashMap_LinkedHashMap$_empty(t1, B.AsyncCallable), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t6, sourceMap, Q.AsyncEnvironment$(sourceMap), P.LinkedHashSet_LinkedHashSet$_empty(t1), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t5, C.Configuration_Map_empty_null_true);
    ...
    _EvaluateVisitor$2: function(functions, importCache, logger, nodeImporter, sourceMap) {
      var t6,
        t1 = P.String,
        t2 = P.Uri,
        t3 = [G.Module0, B.AsyncCallable0],
        t4 = B.AstNode0,
        t5 = H.setRuntimeTypeInfo([], [[S.Tuple2, P.String, B.AstNode0]]);
      if (nodeImporter == null)
        t6 = importCache == null ? O.AsyncImportCache$none(logger) : importCache;
      else
        t6 = null;
      t1 = new E._EvaluateVisitor2(t6, nodeImporter, P.LinkedHashMap_LinkedHashMap$_empty(t1, B.AsyncCallable0), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), C.C_StderrLogger, sourceMap, Q.AsyncEnvironment$0(sourceMap), P.LinkedHashSet_LinkedHashSet$_empty(t1), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t5, C.Configuration_Map_empty_null_true0);
    ...
    MultiSpanSassException$0: function(message, span, primaryLabel, secondarySpans) {
      return new E.MultiSpanSassException0(primaryLabel, H.ConstantMap_ConstantMap$from(secondarySpans, Y.FileSpan, P.String), message, span);
    },
    ...
    MultiSpanSassRuntimeException$0: function(message, span, primaryLabel, secondarySpans, trace) {
      return new E.MultiSpanSassRuntimeException0(trace, primaryLabel, H.ConstantMap_ConstantMap$from(secondarySpans, Y.FileSpan, P.String), message, span);
    },
    ...
    MultiSpanSassScriptException$0: function(message, primaryLabel, secondarySpans) {
      return new E.MultiSpanSassScriptException0(primaryLabel, H.ConstantMap_ConstantMap$from(secondarySpans, Y.FileSpan, P.String), message);
    },
  ...
  F = {ValueResult: function ValueResult(t0, t1) {
    ...
    Extender$_mode0: function(_mode) {
      ...
      return new F.Extender0(P.LinkedHashMap_LinkedHashMap$_empty(t1, [P.Set, [F.ModifiableCssValue0, D.SelectorList0]]), P.LinkedHashMap_LinkedHashMap$_empty(t1, [P.Map, S.ComplexSelector0, S.Extension0]), P.LinkedHashMap_LinkedHashMap$_empty(t1, [P.List, S.Extension0]), P.LinkedHashMap_LinkedHashMap$_empty([F.ModifiableCssValue0, D.SelectorList0], [P.List, F.CssMediaQuery0]), P._LinkedIdentityHashMap__LinkedIdentityHashMap$es6(t1, P.int), new P._LinkedIdentityHashSet([S.ComplexSelector0]), _mode);
    },
    ...
    ModifiableCssImport$0: function(url, span, media, supports) {
      return new F.ModifiableCssImport0(url, supports, media == null ? null : P.List_List$unmodifiable(media, F.CssMediaQuery0), span);
    },
    ...
    CssMediaQuery$0: function(type, features, modifier) {
      return new F.CssMediaQuery0(modifier, type, features == null ? C.List_empty : P.List_List$unmodifiable(features, P.String));
    },
  ...
  Y = {StreamCompleter: function StreamCompleter(t0, t1) {
    ...
    unifyComplex0: function(complexes) {
      ...
      complexesWithoutBases = t1.map$1$1(complexes, new Y.unifyComplex_closure0(), [P.List, S.ComplexSelectorComponent0]).toList$0(0);
    ...
    unifyUniversalAndElement0: function(selector1, selector2) {
      var namespace1, name1, t1, namespace2, name2, namespace, $name,
        _s45_ = "must be a UniversalSelector or a TypeSelector";
      if (!!selector1.$isUniversalSelector0) {
        namespace1 = selector1.namespace;
        name1 = null;
      } else if (!!selector1.$isTypeSelector0) {
        t1 = selector1.name;
        namespace1 = t1.namespace;
        name1 = t1.name;
      } else
        throw H.wrapException(P.ArgumentError$value(selector1, "selector1", _s45_));
      t1 = J.getInterceptor$(selector2);
      if (!!t1.$isUniversalSelector0) {
        namespace2 = selector2.namespace;
        name2 = null;
      } else if (!!t1.$isTypeSelector0) {
        t1 = selector2.name;
        namespace2 = t1.namespace;
        name2 = t1.name;
      } else
    ...
    weave0: function(complexes) {
      var t2, t3, t4, target, _i, parents, newPrefixes, parentPrefixes, t5,
        t1 = [[P.List, S.ComplexSelectorComponent0]],
        prefixes = H.setRuntimeTypeInfo([J.toList$0$ax(C.JSArray_methods.get$first(complexes))], t1);
      for (t2 = H.SubListIterable$(complexes, 1, null, H.getTypeArgumentByIndex(complexes, 0)), t2 = new H.ListIterator(t2, t2.get$length(t2)); t2.moveNext$0();) {
        t3 = t2.__internal$_current;
        t4 = J.getInterceptor$asx(t3);
    ...
    _weaveParents0: function(parents1, parents2) {
      var finalCombinators, root1, root2, root, groups1, groups2, lcs, t2, t3, choices, t4, _i, group, t5,
        t1 = S.ComplexSelectorComponent0,
        queue1 = P.ListQueue_ListQueue$of(parents1, t1),
        queue2 = P.ListQueue_ListQueue$of(parents2, t1),
        initialCombinators = Y._mergeInitialCombinators0(queue1, queue2);
      if (initialCombinators == null)
        return;
      finalCombinators = Y._mergeFinalCombinators0(queue1, queue2, null);
      if (finalCombinators == null)
        return;
      ...
      t2 = [P.Iterable, S.ComplexSelectorComponent0];
      t3 = [t2];
      choices = H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([initialCombinators], t3)], [[P.List, [P.Iterable, S.ComplexSelectorComponent0]]]);
      for (t4 = lcs.length, _i = 0; _i < lcs.length; lcs.length === t4 || (0, H.throwConcurrentModificationError)(lcs), ++_i) {
        group = lcs[_i];
        t5 = Y._chunks0(groups1, groups2, new Y._weaveParents_closure7(group), t1);
        choices.push(new H.MappedListIterable(t5, new Y._weaveParents_closure8(), [H.getTypeArgumentByIndex(t5, 0), t2]).toList$0(0));
        choices.push(H.setRuntimeTypeInfo([group], t3));
        groups1.removeFirst$0();
        groups2.removeFirst$0();
      }
      t3 = Y._chunks0(groups1, groups2, new Y._weaveParents_closure9(), t1);
      choices.push(new H.MappedListIterable(t3, new Y._weaveParents_closure10(), [H.getTypeArgumentByIndex(t3, 0), t2]).toList$0(0));
      C.JSArray_methods.addAll$1(choices, finalCombinators);
      return J.map$1$1$ax(Y.paths0(new H.WhereIterable(choices, new Y._weaveParents_closure11(), [H.getTypeArgumentByIndex(choices, 0)]), t2), new Y._weaveParents_closure12(), t1);
    },
    ...
    _mergeInitialCombinators0: function(components1, components2) {
      ...
      while (true) {
        ...
        if (!t3)
          break;
        combinators1.push(H.interceptedTypeCast(components1.removeFirst$0(), "$isCombinator0"));
      }
      combinators2 = H.setRuntimeTypeInfo([], t2);
      while (true) {
        if (!components2.get$isEmpty(components2)) {
          ...
          if (t2 === components2._collection$_tail)
            H.throwExpression(H.IterableElementError_noElement());
          t2 = components2._collection$_table[t2] instanceof S.Combinator0;
        } else
          t2 = false;
        if (!t2)
          break;
        combinators2.push(H.interceptedTypeCast(components2.removeFirst$0(), "$isCombinator0"));
      }
      lcs = B.longestCommonSubsequence0(combinators1, combinators2, null, t1);
      if (C.C_ListEquality.equals$2(lcs, combinators1))
        return combinators2;
      if (C.C_ListEquality.equals$2(lcs, combinators2))
        return combinators1;
    ...
    _mergeFinalCombinators0: function(components1, components2, result) {
      var t1, t2, combinators1, combinators2, lcs, combinator1, combinator2, compound1, compound2, choices, unified, followingSiblingSelector, nextSiblingSelector, _null = null;
      if (result == null)
        result = Q.QueueList$(_null, [P.List, [P.List, S.ComplexSelectorComponent0]]);
      ...
      while (true) {
        if (!(!components1.get$isEmpty(components1) && components1.get$last(components1) instanceof S.Combinator0))
          break;
        combinators1.push(H.interceptedTypeCast(components1.removeLast$0(0), "$isCombinator0"));
      }
      combinators2 = H.setRuntimeTypeInfo([], t2);
      while (true) {
        if (!(!components2.get$isEmpty(components2) && components2.get$last(components2) instanceof S.Combinator0))
          break;
        combinators2.push(H.interceptedTypeCast(components2.removeLast$0(0), "$isCombinator0"));
      }
      t2 = combinators1.length;
      if (t2 > 1 || combinators2.length > 1) {
        lcs = B.longestCommonSubsequence0(combinators1, combinators2, _null, t1);
        if (C.C_ListEquality.equals$2(lcs, combinators1))
          result.addFirst$1(H.setRuntimeTypeInfo([P.List_List$from(new H.ReversedListIterable(combinators2, [H.getTypeArgumentByIndex(combinators2, 0)]), true, S.ComplexSelectorComponent0)], [[P.List, S.ComplexSelectorComponent0]]));
        else if (C.C_ListEquality.equals$2(lcs, combinators2))
          result.addFirst$1(H.setRuntimeTypeInfo([P.List_List$from(new H.ReversedListIterable(combinators1, [H.getTypeArgumentByIndex(combinators1, 0)]), true, S.ComplexSelectorComponent0)], [[P.List, S.ComplexSelectorComponent0]]));
        else
          return;
        return result;
      }
      ...
      t1 = combinator1 != null;
      if (t1 && combinator2 != null) {
        compound1 = H.interceptedTypeCast(components1.removeLast$0(0), "$isCompoundSelector0");
        compound2 = H.interceptedTypeCast(components2.removeLast$0(0), "$isCompoundSelector0");
        ...
        if (t1 && combinator2 === C.Combinator_CzM0) {
          ...
          if (Y.compoundIsSuperselector0(compound1, compound2, _null))
            result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([compound2, C.Combinator_CzM0], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
          else {
            compound2.toString;
            t1 = [S.ComplexSelectorComponent0];
            t2 = [[P.List, S.ComplexSelectorComponent0]];
          ...
          if (t2) {
            ...
            if (combinator1 === C.Combinator_sgq0)
              ...
              t2 = false;
            if (t2) {
              result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([compound2, combinator2], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
              components1._add$1(compound1);
              ...
              if (combinator2 === C.Combinator_sgq0)
                ...
                t1 = false;
              if (t1) {
                result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([compound1, combinator1], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
                components2._add$1(compound2);
                ...
                if (unified == null)
                  return;
                result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([unified, combinator1], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
              } else
                return;
            }
          }
        ...
        if (combinator1 === C.Combinator_sgq0)
          if (!components2.get$isEmpty(components2)) {
            t1 = H.interceptedTypeCast(components2.get$last(components2), "$isCompoundSelector0");
            t2 = H.interceptedTypeCast(components1.get$last(components1), "$isCompoundSelector0");
            t1.toString;
            t2 = Y.compoundIsSuperselector0(t1, t2, _null);
            t1 = t2;
          } else
            t1 = false;
        else
        ...
        if (t1)
          components2.removeLast$0(0);
        result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([components1.removeLast$0(0), combinator1], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
        return Y._mergeFinalCombinators0(components1, components2, result);
      } else {
        if (combinator2 === C.Combinator_sgq0)
          if (!components1.get$isEmpty(components1)) {
            t1 = H.interceptedTypeCast(components1.get$last(components1), "$isCompoundSelector0");
            t2 = H.interceptedTypeCast(components2.get$last(components2), "$isCompoundSelector0");
            t1.toString;
            t2 = Y.compoundIsSuperselector0(t1, t2, _null);
            t1 = t2;
          } else
        ...
        if (t1)
          components1.removeLast$0(0);
        result.addFirst$1(H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([components2.removeLast$0(0), combinator2], [S.ComplexSelectorComponent0])], [[P.List, S.ComplexSelectorComponent0]]));
        return Y._mergeFinalCombinators0(components1, components2, result);
      }
    },
    _mustUnify0: function(complex1, complex2) {
      var t2, t3, t4,
        t1 = P.LinkedHashSet_LinkedHashSet(M.SimpleSelector0);
      for (t2 = J.get$iterator$ax(complex1); t2.moveNext$0();) {
        t3 = t2.get$current(t2);
    ...
    _isUnique0: function(simple) {
      var t1 = J.getInterceptor$(simple);
      if (!t1.$isIDSelector0)
        t1 = !!t1.$isPseudoSelector0 && !simple.isClass;
      else
        t1 = true;
      return t1;
    },
    ...
    paths0: function(choices, $T) {
      return J.fold$2$ax(choices, H.setRuntimeTypeInfo([H.setRuntimeTypeInfo([], [$T])], [[P.List, $T]]), new Y.paths_closure0($T));
    },
    _groupSelectors0: function(complex) {
      var t1, group, t2, t3,
        groups = Q.QueueList$(null, [P.List, S.ComplexSelectorComponent0]),
        iterator = P._ListQueueIterator$(complex);
      if (!iterator.moveNext$0())
        return groups;
      t1 = [S.ComplexSelectorComponent0];
    ...
    complexIsParentSuperselector0: function(complex1, complex2) {
      ...
      if (t1.get$length(complex1) > t2.get$length(complex2))
        return false;
      base = X.CompoundSelector$0(H.setRuntimeTypeInfo([new N.PlaceholderSelector0("<temp>")], [M.SimpleSelector0]));
      t3 = [S.ComplexSelectorComponent0];
      t4 = H.setRuntimeTypeInfo([], t3);
      for (t1 = t1.get$iterator(complex1); t1.moveNext$0();)
        t4.push(t1.get$current(t1));
      t4.push(base);
    ...
    complexIsSuperselector0: function(complex1, complex2) {
      ...
      for (t1 = H.getTypeArgumentByIndex(complex2, 0), i1 = 0, i2 = 0; true;) {
        ...
        if (remaining1 > remaining2)
          return false;
        t2 = complex1[i1];
        if (t2 instanceof S.Combinator0)
          return false;
        if (complex2[i2] instanceof S.Combinator0)
          return false;
        H.interceptedTypeCast(t2, "$isCompoundSelector0");
        if (remaining1 === 1)
          return Y.compoundIsSuperselector0(t2, H.interceptedTypeCast(C.JSArray_methods.get$last(complex2), "$isCompoundSelector0"), H.SubListIterable$(complex2, 0, complex2.length - 1, t1).skip$1(0, i2));
        afterSuperselector = i2 + 1;
        for (afterSuperselector0 = afterSuperselector; afterSuperselector0 < complex2.length; ++afterSuperselector0) {
          t3 = afterSuperselector0 - 1;
          compound2 = complex2[t3];
          if (compound2 instanceof X.CompoundSelector0)
            if (Y.compoundIsSuperselector0(t2, compound2, H.SubListIterable$(complex2, 0, t3, t1).skip$1(0, afterSuperselector)))
              break;
        }
        if (afterSuperselector0 === complex2.length)
          return false;
    ...
    _selectorPseudosNamed0: function(compound, $name, isClass) {
      var t1 = D.PseudoSelector0;
      return new H.WhereIterable(new H.WhereTypeIterable(compound.components, [t1]), new Y._selectorPseudosNamed_closure0(isClass, $name), [t1]);
    },
    ...
    repl$body: function(options) {
      var $async$goto = 0,
        ...
        $async$handler = 1, $async$currentError, $async$next = [], repl, logger, evaluator, line, declaration, error, stackTrace, t6, t7, t8, t9, t10, line0, exception, t1, t2, t3, t4, t5, repl0;
            ...
            case 7:
              ...
              try {
                if (J.startsWith$1$s(line, "@")) {
                  ...
                  t8 = new L.ScssParser(P.LinkedHashMap_LinkedHashMap$_empty(t1, t3), new S.SpanScanner(t10, null, t7), t8).parseUseRule$0();
                ...
                if (new G.Parser(new S.SpanScanner(t8, null, t6), C.StderrLogger_false)._isVariableDeclarationLike$0()) {
                  ...
                  declaration = new L.ScssParser(P.LinkedHashMap_LinkedHashMap$_empty(t1, t3), new S.SpanScanner(t9, null, t6), t7).parseVariableDeclaration$0();
                  t7 = evaluator;
                  ...
                  if (t8 == null)
                    t8 = C.StderrLogger_false;
                  t8 = new L.ScssParser(P.LinkedHashMap_LinkedHashMap$_empty(t1, t3), new S.SpanScanner(t10, null, t7), t8);
                  t8 = t8._parseSingleProduction$1$1(t8.get$expression(), t2);
  ...
  L = {StreamGroup: function StreamGroup(t0, t1, t2) {
    ...
    Declaration$0: function($name, span, children, value) {
      var t1;
      children = children == null ? null : P.List_List$unmodifiable(children, O.Statement0);
  ...
  Q = {Repl: function Repl(t0, t1, t2, t3) {
    ...
    AsyncEnvironment$0: function(sourceMap) {
      var _null = null,
        t1 = P.String,
        t2 = [G.Module0, B.AsyncCallable0],
        t3 = B.AstNode0,
        t4 = H.setRuntimeTypeInfo([], [t2]),
        t5 = H.setRuntimeTypeInfo([P.LinkedHashMap_LinkedHashMap$_empty(t1, F.Value0)], [[P.Map, P.String, F.Value0]]),
        t6 = sourceMap ? H.setRuntimeTypeInfo([P.LinkedHashMap_LinkedHashMap$_empty(t1, t3)], [[P.Map, P.String, B.AstNode0]]) : _null,
        t7 = P.int,
        t8 = B.AsyncCallable0,
        t9 = [[P.Map, P.String, B.AsyncCallable0]];
    ...
    BuiltInCallable$function0: function($name, $arguments, callback, url) {
      var t1 = S.SpanScanner$("@function " + $name + "(" + $arguments + ") {", url);
      return new Q.BuiltInCallable0($name, H.setRuntimeTypeInfo([new S.Tuple2(new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0(), callback, [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}])], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]));
    },
    BuiltInCallable$mixin0: function($name, $arguments, callback, url) {
      var t1 = S.SpanScanner$("@mixin " + $name + "(" + $arguments + ") {", url);
      return new Q.BuiltInCallable0($name, H.setRuntimeTypeInfo([new S.Tuple2(new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0(), new Q.BuiltInCallable$mixin_closure0(callback), [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}])], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]));
    },
    BuiltInCallable$parsed: function($name, $arguments, callback) {
      return new Q.BuiltInCallable0($name, H.setRuntimeTypeInfo([new S.Tuple2($arguments, callback, [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}])], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]));
    },
    BuiltInCallable$overloadedFunction0: function($name, overloads) {
      var t2, t3, t4, t5, t6, t7, t8, t9, t10,
        t1 = H.setRuntimeTypeInfo([], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]);
      for (t2 = overloads.get$entries(), t2 = t2.get$iterator(t2), t3 = [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}], t4 = P.String, t5 = Z.VariableDeclaration0, t6 = [P.int]; t2.moveNext$0();) {
        t7 = t2.get$current(t2);
        t8 = "@function " + $name + "(" + H.S(t7.key) + ") {";
        t9 = new H.CodeUnits(t8);
        t10 = H.setRuntimeTypeInfo([0], t6);
    ...
    BuiltInModule$0: function($name, functions, mixins, variables, $T) {
      var t1 = P._Uri__Uri(null, $name, null, "sass"),
        ...
        t4 = variables == null ? C.Map_empty8 : new P.UnmodifiableMapView(variables, [P.String, F.Value0]);
      return new Q.BuiltInModule0(t1, t2, t3, t4, [$T]);
    },
  ...
  B = {ReplAdapter: function ReplAdapter(t0) {
    ...
    ArgumentDeclaration_ArgumentDeclaration$parse0: function(contents, url) {
      var t1 = S.SpanScanner$(contents, url);
      return new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0();
    },
    ...
    readFile0: function(path) {
      var t1, t2, t3, sourceFile, i,
        contents = H.stringTypeCast(B._readFile0(path, "utf8"));
      if (!J.getInterceptor$asx(contents).contains$1(contents, "\ufffd"))
        return contents;
      t1 = $.$get$context().toUri$1(path);
      t2 = new H.CodeUnits(contents);
    ...
    _systemErrorToFileSystemException0: function(callback) {
      ...
      try {
        ...
        error = H.unwrapException(exception);
        systemError = H.interceptedTypeCast(error, "$is_SystemError0");
        t1 = systemError;
        t2 = J.getInterceptor$x(t1);
    ...
    _renderSync: function(options) {
      ...
      try {
        ...
        if (t1.get$data(options) != null) {
          ...
          t1 = D.absolute(".");
          result = U._compileStylesheet1(stylesheet, _null, _null, t3, new F.FilesystemImporter0(t1), new H.CastList(t4, [H.getTypeArgumentByIndex(t4, 0), D.Callable0]), t6, !t7, t8, t9, t10, true);
          ...
          result = U._compileStylesheet1(stylesheet, _null, _null, t3, new F.FilesystemImporter0(D.absolute(".")), new H.CastList(t4, [H.getTypeArgumentByIndex(t4, 0), D.Callable0]), t6, !t7, t8, t1, t9, true);
        } else {
    ...
    _exactlyOne0: function(paths) {
      ...
      if (t1 === 1)
        return C.JSArray_methods.get$first(paths);
      throw H.wrapException("It's not clear which file to import. Found:\n" + C.JSArray_methods.map$1$1(paths, new B._exactlyOne_closure0(), P.String).join$1(0, "\n"));
    },
    ...
    indent0: function(string, indentation) {
      var t1 = P.String,
        t2 = H.setRuntimeTypeInfo(string.split("\n"), [t1]);
      return new H.MappedListIterable(t2, new B.indent_closure0(indentation), [H.getTypeArgumentByIndex(t2, 0), t1]).join$1(0, "\n");
    },
    ...
    flattenVertically0: function(iterable, $T) {
      var result,
        queues = new H.MappedListIterable(iterable, new B.flattenVertically_closure1($T), [H.getRuntimeTypeArgument(iterable, "ListIterable", 0), [Q.QueueList, $T]]).toList$0(0);
      if (queues.length === 1)
        return C.JSArray_methods.get$first(queues);
      result = H.setRuntimeTypeInfo([], [$T]);
      for (; queues.length !== 0;) {
    ...
    longestCommonSubsequence0: function(list1, list2, select, $T) {
      ...
      t1 = J.getInterceptor$asx(list1);
      lengths = P.List_List$generate(t1.get$length(list1) + 1, new B.longestCommonSubsequence_closure3(list2), false, [P.List, P.int]);
      selections = P.List_List$generate(t1.get$length(list1), new B.longestCommonSubsequence_closure4(list2, $T), false, [P.List, $T]);
      for (t2 = J.getInterceptor$asx(list2), i = 0; i < t1.get$length(list1); i = i0)
        for (i0 = i + 1, j = 0; j < t2.get$length(list2); j = j0) {
          selection = select.call$2(t1.$index(list1, i), t2.$index(list2, j));
          J.$indexSet$ax(selections[i], j, selection);
    ...
    mapAsync0: function(iterable, callback, $E, $F) {
      return B.mapAsync$body0(iterable, callback, $E, $F, [P.Iterable, $F]);
    },
    ...
    mapMapAsync0: function(map, value, K1, V1, K2, V2) {
      return B.mapMapAsync$body0(map, value, K1, V1, K2, V2, [P.Map, K2, V2]);
    },
  ...
  O = {
    ...
    AsyncImportCache$none: function(logger) {
      var t1 = P.Uri;
      return new O.AsyncImportCache0(C.C_StderrLogger, P.LinkedHashMap_LinkedHashMap$_empty([S.Tuple2, P.Uri, P.bool], [S.Tuple3, B.AsyncImporter0, P.Uri, P.Uri]), P.LinkedHashMap_LinkedHashMap$_empty(t1, V.Stylesheet0), P.LinkedHashMap_LinkedHashMap$_empty(t1, E.ImporterResult0));
    },
  ...
  U = {DefaultEquality: function DefaultEquality() {
    ...
    AtRule$0: function($name, span, children, value) {
      var t1 = children == null ? null : P.List_List$unmodifiable(children, O.Statement0),
          ...
          switch ($async$goto) {
            ...
            case 19:
              ...
              if (!!t3.$isSassException) {
                ...
                if (t2._parser.options._map.$index(0, "color") == null)
  ...
  X = {
    ...
    ArgumentInvocation$0: function(positional, named, span, keywordRest, rest) {
      var t1 = T.Expression0;
      return new X.ArgumentInvocation0(P.List_List$unmodifiable(positional, t1), H.ConstantMap_ConstantMap$from(named, P.String, t1), rest, keywordRest, span);
    },
    ...
    compileAsync0: function(path, functions, indentWidth, lineFeed, nodeImporter, sourceMap, style, syntax, useSpaces) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(X.CompileResult0),
    ...
    CompoundSelector$0: function(components) {
      var t1 = P.List_List$unmodifiable(components, M.SimpleSelector0);
      if (t1.length === 0)
        H.throwExpression(P.ArgumentError$("components may not be empty."));
    ...
    Interpolation$0: function(contents, span) {
      var t1 = new X.Interpolation0(P.List_List$unmodifiable(contents, P.Object), span);
    ...
    ModifiableCssStyleRule$0: function(selector, span, originalSelector) {
      var t1 = originalSelector == null ? selector.value : originalSelector,
        t2 = B.ModifiableCssNode0,
        t3 = H.setRuntimeTypeInfo([], [t2]);
      return new X.ModifiableCssStyleRule0(selector, t1, span, new P.UnmodifiableListView(t3, [t2]), t3);
    },
  ...
  K = {
    ...
    _functionString0: function($name, $arguments) {
      return new D.SassString0($name + "(" + J.map$1$1$ax($arguments, new K._functionString_closure0(), P.String).join$1(0, ", ") + ")", false);
    },
    _removedColorFunction0: function($name, argument, negative) {
      var t1 = S.SpanScanner$("@function " + $name + "($color, $amount) {", "sass:color");
      return new Q.BuiltInCallable0($name, H.setRuntimeTypeInfo([new S.Tuple2(new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0(), new K._removedColorFunction_closure0($name, argument, negative), [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}])], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]));
    },
    ...
    _rgbTwoArg0: function($name, $arguments) {
      ...
      if (t1.$index($arguments, 0).get$isVar())
        ...
        if (first instanceof K.SassColor0) {
          ...
          t1 = t1.$index($arguments, 1);
          t1.toString;
          return new D.SassString0(t2 + N.serializeValue0(t1, false, true) + ")", false);
        } else
          return K._functionString0($name, $arguments);
      } else if (t1.$index($arguments, 1).get$isSpecialNumber()) {
        color = t1.$index($arguments, 0).assertColor$1("color");
    ...
    _parseChannels0: function($name, argumentNames, channels) {
      var isCommaSeparated, isBracketed, buffer, t1, list, maybeSlashSeparated, t2, t3,
        ...
        _s32_ = "$channels must be an unbracketed";
      if (channels.get$isVar())
        return K._functionString0($name, H.setRuntimeTypeInfo([channels], [F.Value0]));
      ...
      maybeSlashSeparated = list[2];
      t1 = J.getInterceptor$(maybeSlashSeparated);
      if (!!t1.$isSassNumber0 && maybeSlashSeparated.asSlash != null) {
        t1 = list[0];
        t2 = list[1];
        t3 = maybeSlashSeparated.asSlash;
        return H.setRuntimeTypeInfo([t1, t2, t3.item1, t3.item2], [F.Value0]);
      } else if (!!t1.$isSassString0 && !maybeSlashSeparated.hasQuotes && J.contains$1$asx(maybeSlashSeparated.text, "/"))
        return K._functionString0($name, H.setRuntimeTypeInfo([channels], [F.Value0]));
      else
        return list;
    },
    ...
    LimitedMapView$safelist0: function(_map, safelist, $K, $V) {
      return new K.LimitedMapView0(_map, safelist._base.intersection$1(new M.MapKeySet(_map, [P.Object])), [$K, $V]);
    },
    LimitedMapView$blocklist0: function(_map, blocklist, $K, $V) {
      ...
      return new K.LimitedMapView0(_map, t1, [$K, $V]);
    },
    ...
    _numberFunction0: function($name, transform) {
      var t1 = S.SpanScanner$("@function " + $name + "($number) {", "sass:math");
      return new Q.BuiltInCallable0($name, H.setRuntimeTypeInfo([new S.Tuple2(new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0(), new K._numberFunction_closure0(transform), [B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}])], [[S.Tuple2, B.ArgumentDeclaration0, {func: 1, ret: F.Value0, args: [[P.List, F.Value0]]}]]));
    },
  ...
  R = {ModifiableCssComment: function ModifiableCssComment(t0, t1) {
    ...
    _EvaluateVisitor$: function(functions, importCache, logger, nodeImporter, sourceMap) {
      var t1 = P.String,
        ...
        t5 = H.setRuntimeTypeInfo([], [[S.Tuple2, P.String, B.AstNode]]),
        t6 = logger == null ? C.StderrLogger_false : logger;
      t5 = new R._EvaluateVisitor(importCache, nodeImporter, P.LinkedHashMap_LinkedHashMap$_empty(t1, D.Callable), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t6, sourceMap, O.Environment$(sourceMap), P.LinkedHashSet_LinkedHashSet$_empty(t1), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t5, C.Configuration_Map_empty_null_true);
    ...
    _EvaluateVisitor$1: function(functions, importCache, logger, nodeImporter, sourceMap) {
      ...
      if (nodeImporter == null)
        ...
        t6 = null;
      t1 = new R._EvaluateVisitor1(t6, nodeImporter, P.LinkedHashMap_LinkedHashMap$_empty(t1, D.Callable0), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t3), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), C.C_StderrLogger, sourceMap, O.Environment$0(sourceMap), P.LinkedHashSet_LinkedHashSet$_empty(t1), P.LinkedHashMap_LinkedHashMap$_empty(t2, t4), t5, C.Configuration_Map_empty_null_true0);
    ...
    ForwardedModuleView$0: function(_inner, _rule, $T) {
      var t5,
        ...
        t2 = _rule.shownVariables,
        t3 = _rule.hiddenVariables,
        t4 = R.ForwardedModuleView__forwardedMap0(_inner.get$variables(), t1, t2, t3, F.Value0);
      t2 = _inner.get$variableNodes() == null ? null : R.ForwardedModuleView__forwardedMap0(_inner.get$variableNodes(), t1, t2, t3, B.AstNode0);
      t3 = _rule.shownMixinsAndFunctions;
      t5 = _rule.hiddenMixinsAndFunctions;
      return new R.ForwardedModuleView0(_inner, _rule, t4, t2, R.ForwardedModuleView__forwardedMap0(_inner.get$functions(_inner), t1, t3, t5, $T), R.ForwardedModuleView__forwardedMap0(_inner.get$mixins(), t1, t3, t5, $T), [$T]);
    },
    ForwardedModuleView__forwardedMap0: function(map, prefix, safelist, blocklist, $V) {
      ...
      if (t2)
        return map;
      if (!t1)
        map = new F.PrefixedMapView0(map, prefix, [$V]);
      if (safelist != null)
        map = K.LimitedMapView$safelist0(map, safelist, P.String, $V);
      else {
        if (blocklist != null) {
          t1 = blocklist._base;
          t1 = t1.get$isNotEmpty(t1);
          ...
          t1 = false;
        if (t1)
          map = K.LimitedMapView$blocklist0(map, blocklist, P.String, $V);
      }
      return map;
    },
    ...
    ImportCache$none: function(logger) {
      var t1 = P.Uri;
      return new R.ImportCache0(C.C_StderrLogger, P.LinkedHashMap_LinkedHashMap$_empty([S.Tuple2, P.Uri, P.bool], [S.Tuple3, M.Importer0, P.Uri, P.Uri]), P.LinkedHashMap_LinkedHashMap$_empty(t1, V.Stylesheet0), P.LinkedHashMap_LinkedHashMap$_empty(t1, E.ImporterResult0));
    },
    ...
    _wrapMain: function(main) {
      if (H.functionTypeTest(main, {func: 1, ret: P.Object}))
  ...
  T = {Expression: function Expression() {
    ...
    SassNumber$withUnits0: function(value, denominatorUnits, numeratorUnits) {
      var t1 = numeratorUnits == null ? C.List_empty : P.List_List$unmodifiable(numeratorUnits, P.String);
      return new T.SassNumber0(value, t1, denominatorUnits == null ? C.List_empty : P.List_List$unmodifiable(denominatorUnits, P.String), null);
    },
    ...
    _prependParent0: function(compound) {
      var t3, _i,
        ...
        first = C.JSArray_methods.get$first(t1),
        t2 = J.getInterceptor$(first);
      if (!!t2.$isUniversalSelector0)
        return;
      if (!!t2.$isTypeSelector0) {
        t2 = first.name;
        if (t2.namespace != null)
          return;
        t3 = H.setRuntimeTypeInfo([], [M.SimpleSelector0]);
        t3.push(new M.ParentSelector0(t2.name));
        for (t1 = H.SubListIterable$(t1, 1, null, H.getTypeArgumentByIndex(t1, 0)), t1 = new H.ListIterator(t1, t1.get$length(t1)); t1.moveNext$0();)
          t3.push(t1.__internal$_current);
        return X.CompoundSelector$0(t3);
      } else {
        t2 = H.setRuntimeTypeInfo([], [M.SimpleSelector0]);
        t2.push(new M.ParentSelector0(null));
        for (t3 = t1.length, _i = 0; _i < t3; ++_i)
          t2.push(t1[_i]);
  ...
  D = {ListExpression: function ListExpression(t0, t1, t2, t3) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 13:
              ...
              $async$goto = 14;
              return P._asyncAwait(X.compileStringAsync(t2, H.boolTypeCast(t1.$index(0, "charset")), importCache, new F.FilesystemImporter(t5), t4, t7, t6, t3), $async$compileStylesheet);
            case 14:
              // returning from await.
            ...
            case 12:
              ...
              $async$goto = 15;
              return P._asyncAwait(X.compileAsync(source, H.boolTypeCast(t1.$index(0, "charset")), importCache, t3, t5, t4, t2), $async$compileStylesheet);
            case 15:
              // returning from await.
              result0 = $async$result;
            case 11:
            ...
            case 19:
              ...
              t6 = J.$eq$(t1.$index(0, "style"), "compressed") ? C.OutputStyle_compressed : C.OutputStyle_expanded;
              t7 = options.get$emitSourceMap();
              t1 = H.boolTypeCast(t1.$index(0, "charset"));
    ...
    SelectorList$0: function(components) {
      var t1 = P.List_List$unmodifiable(components, S.ComplexSelector0);
      if (t1.length === 0)
        H.throwExpression(P.ArgumentError$("components may not be empty."));
    ...
    SassList$0: function(contents, separator, brackets) {
      var t1 = new D.SassList0(P.List_List$unmodifiable(contents, F.Value0), separator, brackets);
    ...
    SourceMapBuffer0: function SourceMapBuffer0(t0, t1, t2) {
      ...
      _._source_map_buffer0$_sourceFiles = t2;
  ...
  S = {VariableExpression: function VariableExpression(t0, t1, t2) {
    ...
    AsyncBuiltInCallable$mixin0: function($name, $arguments, callback, url) {
      var t1 = S.SpanScanner$("@mixin " + $name + "(" + $arguments + ") {", url);
      return new S.AsyncBuiltInCallable0($name, new L.ScssParser0(P.LinkedHashMap_LinkedHashMap$_empty(P.String, Z.VariableDeclaration0), t1, C.C_StderrLogger).parseArgumentDeclaration$0(), new S.AsyncBuiltInCallable$mixin_closure0(callback));
    },
    ...
    ComplexSelector$0: function(components, lineBreak) {
      var t1 = P.List_List$unmodifiable(components, S.ComplexSelectorComponent0);
      if (t1.length === 0)
        H.throwExpression(P.ArgumentError$("components may not be empty."));
  ...
  H.CastQueue.prototype = {
    ...
    add$1: function(_, value) {
      this._source._add$1(H.subtypeOfRuntimeTypeCast(value, H.getTypeArgumentByIndex(this, 0)));
    },
    $isEfficientLengthIterable: 1,
    $asEfficientLengthIterable: function($S, $T) {
      return [$T];
