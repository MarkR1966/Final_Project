...
(function (ts) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind[SyntaxKind["JSDocNamepathType"] = 297] = "JSDocNamepathType";
        SyntaxKind[SyntaxKind["JSDocComment"] = 298] = "JSDocComment";
        SyntaxKind[SyntaxKind["JSDocTypeLiteral"] = 299] = "JSDocTypeLiteral";
        SyntaxKind[SyntaxKind["JSDocSignature"] = 300] = "JSDocSignature";
        SyntaxKind[SyntaxKind["JSDocTag"] = 301] = "JSDocTag";
        SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 302] = "JSDocAugmentsTag";
        SyntaxKind[SyntaxKind["JSDocAuthorTag"] = 303] = "JSDocAuthorTag";
        SyntaxKind[SyntaxKind["JSDocClassTag"] = 304] = "JSDocClassTag";
        SyntaxKind[SyntaxKind["JSDocCallbackTag"] = 305] = "JSDocCallbackTag";
        SyntaxKind[SyntaxKind["JSDocEnumTag"] = 306] = "JSDocEnumTag";
        ...
        SyntaxKind[SyntaxKind["JSDocPropertyTag"] = 313] = "JSDocPropertyTag";
        // Synthesized list
        SyntaxKind[SyntaxKind["SyntaxList"] = 314] = "SyntaxList";
        // Transformation nodes
        SyntaxKind[SyntaxKind["NotEmittedStatement"] = 315] = "NotEmittedStatement";
        SyntaxKind[SyntaxKind["PartiallyEmittedExpression"] = 316] = "PartiallyEmittedExpression";
        SyntaxKind[SyntaxKind["CommaListExpression"] = 317] = "CommaListExpression";
        SyntaxKind[SyntaxKind["MergeDeclarationMarker"] = 318] = "MergeDeclarationMarker";
        SyntaxKind[SyntaxKind["EndOfDeclarationMarker"] = 319] = "EndOfDeclarationMarker";
        // Enum value count
        SyntaxKind[SyntaxKind["Count"] = 320] = "Count";
        // Markers
        ...
        SyntaxKind[SyntaxKind["LastJSDocNode"] = 313] = "LastJSDocNode";
        SyntaxKind[SyntaxKind["FirstJSDocTagNode"] = 301] = "FirstJSDocTagNode";
        SyntaxKind[SyntaxKind["LastJSDocTagNode"] = 313] = "LastJSDocTagNode";
    ...
    (function (ObjectFlags) {
        ...
        /* @internal */
        ObjectFlags[ObjectFlags["ContainsWideningType"] = 262144] = "ContainsWideningType";
        /* @internal */
        ObjectFlags[ObjectFlags["ContainsObjectOrArrayLiteral"] = 524288] = "ContainsObjectOrArrayLiteral";
        /* @internal */
        ObjectFlags[ObjectFlags["NonInferrableType"] = 1048576] = "NonInferrableType";
        ObjectFlags[ObjectFlags["ClassOrInterface"] = 3] = "ClassOrInterface";
        /* @internal */
        ObjectFlags[ObjectFlags["RequiresWidening"] = 786432] = "RequiresWidening";
        /* @internal */
        ObjectFlags[ObjectFlags["PropagatingFlags"] = 1835008] = "PropagatingFlags";
    ...
    (function (TransformFlags) {
        ...
        TransformFlags[TransformFlags["ContainsClassFields"] = 1048576] = "ContainsClassFields";
    ...
    (function (ExternalEmitHelpers) {
        ...
        ExternalEmitHelpers[ExternalEmitHelpers["LastEmitHelper"] = 131072] = "LastEmitHelper";
...
(function (ts) {
    ...
    function createSingleFileWatcherPerName(watchFile, useCaseSensitiveFileNames) {
        ...
        return function (fileName, callback, pollingInterval) {
            ...
            if (existing) {
                ...
                cache.set(path, {
                    watcher: watchFile(fileName, function (fileName, eventKind) { return ts.forEach(callbacksCache.get(path), function (cb) { return cb(fileName, eventKind); }); }, pollingInterval),
                    refCount: 1
                });
            }
            ...
            return {
                close: function () {
                    var watcher = ts.Debug.assertDefined(cache.get(path));
    ...
    ts.sys = (function () {
        ...
        function getNodeSystem() {
            ...
            var fsWatchFile = createSingleFileWatcherPerName(fsWatchFileWorker, useCaseSensitiveFileNames);
            ...
            function getWatchFile() {
                ...
                return useNonPollingWatchers ?
                    ...
                    function (fileName, callback) { return fsWatchFile(fileName, callback, /*pollingInterval*/ undefined); };
            }
